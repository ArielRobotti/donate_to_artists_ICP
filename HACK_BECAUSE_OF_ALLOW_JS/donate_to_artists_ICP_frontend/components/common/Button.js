...
const Button = ({ children, primary, secondary, success, warning, danger, outline, rounded, ...rest }) => {
    const classes = className(rest.className, "rounded-full px-3.5 py-2.5 font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600", {
    ...
    return (React.createElement("button", { ...rest, className: classes }, children));
};
Button.propTypes = {
